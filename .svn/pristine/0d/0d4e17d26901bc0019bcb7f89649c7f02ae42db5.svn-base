...
//
//  EXOUWireSignalModelBuilder builds a signal model for U-wire signals.  For
//  more details see InitializeSignalModel.
//
//______________________________________________________________________________
#include "EXOReconstruction/EXOUWireSignalModelBuilder.hh"

//______________________________________________________________________________
bool EXOUWireSignalModelBuilder::InitializationIsNeeded(const EXOSignalModel& model) const
{
...
//______________________________________________________________________________
void EXOUWireSignalModelBuilder::InitializeSignalModel(
    ...
    EXOTransferFunction& transfer) const
{
  ...
  const EXODoubleWaveform& unshaped_sig = EXOMiscUtil::unshaped_signal();
